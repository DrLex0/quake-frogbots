...
- Some examples:
  ...
  - Ugh: _pocket infinity_ by _fourier/infiniti._ Annoying geometry, Quad only reachable by performing speed run tricks after pushing a button, and air strafing is mandatory for one of the teleports in the final version to be useful instead of a hazard. OK as a trick map, not as a regular net map that could invite new players to Quake.
